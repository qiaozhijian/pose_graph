...
public:
    ...
    g2o::VertexSE3Expmap* addSE3ExpNode(const g2o::SE3Quat &pose, const int KFid, const bool& isFixed);
    ...
    void addSE3Edge(g2o::VertexSE3* &v1, const Eigen::Isometry3d &iso_pose,
                               const Matrix6d &info_matrix, int level);
    void addSE3ExpEdge(g2o::VertexSE3Expmap* &v1, const Eigen::Isometry3d &iso_pose,
                               const Matrix6d &info_matrix, int level);
    ...
    void RemoveOutliers(vector<g2o::EdgeSE3*>& Myedges);
